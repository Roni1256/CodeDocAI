...
const DeletionPop = ({
  ...
  return (
    <div className="h-screen w-full flex items-center justify-center fixed top-0 left-0 backdrop-blur-xs">
      <div className="bg-white p-10 rounded-lg border border-gray-300 shadow-md shadow-gray-300 flex flex-col w-1/3 items-center">
        ...
        <p className="text-gray-900 mt-8 text-xl text-justify">
